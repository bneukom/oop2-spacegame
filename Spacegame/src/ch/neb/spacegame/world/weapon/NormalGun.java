...
public class NormalGun extends Gun {
	...
	public NormalGun(long cooldown, World world, GameEntity owner, CollisionListener collisionListener) {
	...
	protected void doShoot(Vec2 position, Vec2 direction) {
		...
		for (int i = 0; i < shots ; ++i) {
			...
			world.addEntity(new Bullet(world, owner, collisionListener, bullet, new Vec2((float) Math.cos(startAngle), (float) Math.sin(startAngle)), shootPosition, 0.9f, 4));
